...
import PriceForMobile from "./PriceForMobile";
      ...
      <div className="hidden lg:block">
        <div className="grid  md:grid-cols-2 lg:grid-cols-3 gap-5 mt-10">
          <motion.div
            ...
            className="xl:w-[400px] h-[450px] bg-white/10 backdrop-blur-sm rounded-xl mt-5 p-10 border border-transparent  hover:border-[#00d094] hover:-translate-y-3 duration-500 cursor-pointer"
          >
